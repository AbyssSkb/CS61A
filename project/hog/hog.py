...
def roll_dice(num_rolls, dice=six_sided):
    ...
    return 1 if is_sow_sad else score
    # END PROBLEM 1
...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    opponent_number = opponent_score // 10 % 10
    player_number = player_score % 10
    return max(1, 3 * abs(player_number - opponent_number))
    # END PROBLEM 2
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    tmp_score = player_score + take_turn(num_rolls, player_score, opponent_score, dice)
    return sus_points(tmp_score)
    # END PROBLEM 4
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    num_rolls = 1
    max_score = 1
    make_averaged_roll_dice = make_averaged(roll_dice, times_called)
    for i in range(1, 11):
        current_score = make_averaged_roll_dice(i, dice)
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # BEGIN PROBLEM 12
    if GOAL - score <= 10:
        return sus_strategy(score, opponent_score, threshold=6, num_rolls=2)
